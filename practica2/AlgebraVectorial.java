 ...
 * version 1.0 15 de septiembre de 2025
 */
public class AlgebraVectorial {
     ...
     */
    public int mutiplicEscalar(AlgebraVectorial O) {
        int suma = 0;
        for (int i = 0; i < O.vector.length; i++) {
    ...
    public String paralela(AlgebraVectorial B, boolean tipo) {
        if (!tipo) {
            ...
            double nB = B.norma(2);
            double nAB = Math.pow((this.mutiplicEscalar(B)), 2);
    ...
    public AlgebraVectorial Proyeccion_de_a_sobre_b(AlgebraVectorial B) {
        double cociente = (this.mutiplicEscalar(B)) / B.norma(2);
    ...
    public double Componente_de_a_en_b(AlgebraVectorial B) {
        if(B.norma()!=0){
            double modulo = this.mutiplicEscalar(B) / B.norma();
            return modulo;
        }
        return -1;
    }
